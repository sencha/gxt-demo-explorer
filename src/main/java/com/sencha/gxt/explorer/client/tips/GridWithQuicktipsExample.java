...
@Detail(
    ...
    maxHeight = GridWithQuicktipsExample.MAX_HEIGHT,
    maxWidth = GridWithQuicktipsExample.MAX_WIDTH,
    minHeight = GridWithQuicktipsExample.MIN_HEIGHT,
    minWidth = GridWithQuicktipsExample.MIN_WIDTH
)
public class GridWithQuicktipsExample implements IsWidget, EntryPoint {
