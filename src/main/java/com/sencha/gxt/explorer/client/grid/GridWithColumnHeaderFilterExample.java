...
@Detail(
  name = "Grid with Column Header Filter",
  category = "Grid",
  icon = "basicgrid",
  classes = { Stock.class, StockProperties.class, TestData.class },
  maxHeight = GridWithColumnHeaderFilterExample.MAX_HEIGHT,
  maxWidth = GridWithColumnHeaderFilterExample.MAX_WIDTH,
  minHeight = GridWithColumnHeaderFilterExample.MIN_HEIGHT,
  minWidth = GridWithColumnHeaderFilterExample.MIN_WIDTH)
public class GridWithColumnHeaderFilterExample implements IsWidget, EntryPoint {
  ...
  protected static final int MIN_WIDTH = 520;

  private static final StockProperties props = GWT.create(StockProperties.class);

  private ContentPanel panel;
  private StringFilter<Stock> nameFilter;
  ...
  public Widget asWidget() {
    if (panel == null) {
      ...
      // Filter in the column header
      final TextField nameHeaderField = new TextField();
      nameHeaderField.setEmptyText("Filter Name");
      nameHeaderField.addValueChangeHandler(new ValueChangeHandler<String>() {
        @Override
        public void onValueChange(ValueChangeEvent<String> event) {
          nameFilter.setValue(nameHeaderField.getCurrentValue());
      ...
      // Filters
      nameFilter = new StringFilter<Stock>(props.name());

      GridFilters<Stock> gridFilters = new GridFilters<Stock>();
